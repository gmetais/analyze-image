...
const debug = debugModule('analyze-image:optimize');
...
export async function optimizeImage(body, format, options) {
  let newFile;
...
export default main;
export const description = 'Checks if image can be optimized';
