...
async function main(runner) {
  ...
  debug('HTML code provided: %s', runner.browserData.html.length > 100 ? runner.browserData.html.substring(0, 100) + '...' : runner.browserData.html);
